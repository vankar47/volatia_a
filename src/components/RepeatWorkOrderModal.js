...
function ModalTester({
  ...
  workOrderToSend.Id = workOrderData.Id;
  workOrderToSend.ClientID = workOrderData.ClientID;

  workOrderToSend.Address2 = workOrderData.Address2;

  workOrderToSend.AssignedTo = workOrderData.AssignedTo;
  workOrderToSend.ClientComments = workOrderData.ClientComments;
  workOrderToSend.CostCenterID = workOrderData.CostCenterID;
  workOrderToSend.FacilityID = workOrderData.FacilityID;
  workOrderToSend.InterpreterPreference = workOrderData.InterpreterPreference;
  workOrderToSend.MRN = workOrderData.MRN;
  workOrderToSend.Provider = workOrderData.Provider;
  workOrderToSend.ProviderEmail = workOrderData.ProviderEmail;
  workOrderToSend.ServiceID = workOrderData.ServiceID;
  workOrderToSend.Start = workOrderData.Start;
  workOrderToSend.Subject = workOrderData.Subject;
  workOrderToSend.LanguageToID = workOrderData.LanguageToID;
                ...
                try {
                  const res = await postRequestForm(
                    ...
                    accessToken,
                    {
                      ...
                      ...value,
                      RecurringRequestedBy: workOrderData.RequestedBy,
                      RecurringRequestedEmail: workOrderData.RequestedByEmail,
                      RecurringRequestedPhone: workOrderData.Telephone,
                    },
                  );
                    ...
                    <View style={{marginTop: 12}}>
                      <DaySlot
                        onSelect={(days) => {
                          ...
                          console.log('showtimesAsString', showtimesAsString);
